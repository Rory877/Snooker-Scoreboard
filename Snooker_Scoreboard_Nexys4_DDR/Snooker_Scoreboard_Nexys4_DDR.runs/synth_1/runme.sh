...
HD_PWD='C:/Users/wdb15166/Downloads/Snooker_Scoreboard_Nexys4_DDR/Snooker_Scoreboard_Nexys4_DDR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment.vds -m64 -mode batch -messageDb vivado.pb -notrace -source seven_segment.tcl
