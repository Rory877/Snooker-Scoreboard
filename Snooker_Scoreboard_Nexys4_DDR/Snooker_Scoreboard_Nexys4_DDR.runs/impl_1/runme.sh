...
HD_PWD='C:/Users/wdb15166/Downloads/Snooker_Scoreboard_Nexys4_DDR/Snooker_Scoreboard_Nexys4_DDR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment.vdi -applog -m64 -messageDb vivado.pb -mode batch -source seven_segment.tcl -notrace
